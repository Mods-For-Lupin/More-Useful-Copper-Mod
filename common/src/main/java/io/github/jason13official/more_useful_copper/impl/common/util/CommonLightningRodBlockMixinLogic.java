...
public class CommonLightningRodBlockMixinLogic {
  ...
  /// Mixin injection: called when a lightning rod is struck. Delegates to [createFilledLightningBottle] on the server side only.
  ///
  ...
  /// Converts one glass bottle in the container directly below the rod into a lightning bottle. If the matching stack has count > 1, the stack is shrunk and the filled bottle is placed in an empty
  /// slot; if no empty slot exists it is given to the nearest player within 64 blocks.
  ///
